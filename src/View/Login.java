...
public class Login extends JFrame {
	...
	public Login() {
		  ...
		  lblNewLabel.setBounds(236, 152, 70, 15);
		  contentPane.add(lblNewLabel);
		  
		  textUsuario = new JTextField();
		  textUsuario.setBounds(310, 150, 114, 19);
		  contentPane.add(textUsuario);
		  textUsuario.setColumns(10);
		  
		  JLabel lblPassword = new JLabel("Password");
		  lblPassword.setBounds(236, 181, 70, 15);
		  contentPane.add(lblPassword);
		  
		  textPassword = new JPasswordField();
		  textPassword.setColumns(10);
		  textPassword.setBounds(310, 179, 114, 19);
		  contentPane.add(textPassword);
		  
		  btnEntrar = new JButton("Entrar");
		  btnEntrar.setBounds(310, 210, 117, 25);
		  contentPane.add(btnEntrar);
		  
		  JLabel lblLoginInventario = new JLabel("Login Inventario");
		  lblLoginInventario.setFont(new Font("Dialog", Font.BOLD, 16));
		  lblLoginInventario.setBounds(258, 110, 166, 15);
		  contentPane.add(lblLoginInventario);
		  
		  labelError = new JLabel("");
		  labelError.setForeground(Color.RED);
		  labelError.setBounds(236, 280, 201, 15);
